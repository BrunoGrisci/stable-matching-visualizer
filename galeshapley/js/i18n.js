(function () {
  const messages = {
    en: {
      ...
      variant_classic: 'Classic Stable Matching',
      variant_good_bad: 'Good and Bad Categories',
      variant_forbidden: 'Forbidden Pairs',
      variant_capacity: 'Hospital Capacities',
      scenario_note_classic: 'Classic one-to-one stable matching between two groups with strict preferences.',
      scenario_note_good_bad: 'Participants are split into good/bad categories and preferences prioritize good first.',
      scenario_note_forbidden: 'Certain proposer-receiver pairs are disallowed and removed from preference lists.',
      scenario_note_capacity: 'Receiver side has capacities and may hold multiple engagements simultaneously.',
      ...
      preset_note_worst_case: 'Classroom worst-case instance (pior caso).',
      preset_note_random: 'Random permutation preferences on both sides.',
      preset_note_inverse: 'Inverse pattern: all proposers share the same order and receivers use reversed proposer order.',
      preset_note_easy: 'Easy pattern where each participant has a unique top choice partner.',
      ...
      forbidden_label: 'Forbidden pairs (man-woman, comma separated)',
      capacity_label: 'Capacities (receiver:cap, comma separated)',
      ...
      insight_optimal_proved: 'Verified on all stable matchings ({count}).',
      insight_optimal_theorem: 'Expected by Gale-Shapley theorem for this setting.',
      insight_optimal_not_verified: 'Not exhaustively verified for this size/variant.',
    ...
    pt: {
      ...
      variant_classic: 'Emparelhamento estável clássico',
      variant_good_bad: 'Categorias boas e ruins',
      variant_forbidden: 'Pares proibidos',
      variant_capacity: 'Capacidades de hospitais',
      scenario_note_classic: 'Emparelhamento estável clássico um-para-um entre dois grupos com preferências estritas.',
      scenario_note_good_bad: 'Participantes são divididos em categorias bom/ruim e preferências priorizam os bons.',
      scenario_note_forbidden: 'Certos pares proponente-receptor são proibidos e removidos das listas de preferência.',
      scenario_note_capacity: 'O lado receptor possui capacidades e pode manter múltiplos noivados simultaneamente.',
      ...
      preset_note_worst_case: 'Instância de pior caso dos slides de aula.',
      preset_note_random: 'Preferências aleatórias (permutações) em ambos os lados.',
      preset_note_inverse: 'Padrão inverso: todos os proponentes têm a mesma ordem e receptores usam ordem inversa dos proponentes.',
      preset_note_easy: 'Padrão fácil em que cada participante tem um parceiro de primeira escolha único.',
      ...
      forbidden_label: 'Pares proibidos (homem-mulher, separados por vírgula)',
      capacity_label: 'Capacidades (receptor:cap, separados por vírgula)',
      ...
      insight_optimal_proved: 'Verificado em todos os emparelhamentos estáveis ({count}).',
      insight_optimal_theorem: 'Esperado pelo teorema de Gale-Shapley neste cenário.',
      insight_optimal_not_verified: 'Não verificado exaustivamente para este tamanho/variante.',
